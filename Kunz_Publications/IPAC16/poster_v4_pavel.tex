...
\includegraphics[width=0.9\textwidth]{mice}
}
...
\headerbox{References}{name=references,column=0,row=2,below=absorbers}
{\tiny
...
\headerbox{MuScat Simulation}{name=muscat,column=1,row=1,below=mice}
{
...
\headerbox{Magnetic coils}{name=coils,column=1,row=1,below=muscat}
{
\begin{center}
